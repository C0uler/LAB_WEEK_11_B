package com.jordan.lab_week_11_b
...
// import org.apache.commons.io.IOUtils // Uncomment if using Apache Commons
    ...
    private fun insertToStore(
        ...
        executor.execute {
            ...
            insertedUri?.let {
                ...
                // Make sure inputStream and outputStream are not null before copying
                if (inputStream != null && outputStream != null) {
                    IOUtils.copy(inputStream, outputStream)
                    // It is good practice to close streams, though IOUtils might handle it depending on version
                    inputStream.close()
                    outputStream.close()
                }
            }
